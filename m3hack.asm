...
org $8040456; db $BE         // Goods
org $8040902; db $BE
org $8040A82; db $B6         // Equip
org $8043016; db $B6
org $804121E; db $C1         // Skills
org $8040C26; db $C5         // PSI
org $80410AE; db $BE         // Status
org $804167E; db $9D         // Battle Memory
org $8041886; db $C2         // Shop
org $8041990; db $C2
org $8041D00; db $C2
org $804181A; db $C2
org $8041F36; db $AA         // Item Dude
org $80420AC; db $AA
org $8042348; db $AA
org $8041FA2; db $AA
...
org $804297A; db $78
org $804297C; db $1B
org $8045D0E; db $12       // Invalid/duplicate name
...
org $9C86E98; incbin font_creditsfont_arrangement.bin
...
org $80C20E8; db $BE         // Goods
org $80C20EA; db $B6         // Equip
org $80C20EC; db $C5         // PSI
org $80C20EE; db $BE         // Status
org $80C20F0; db $C2         // Sleep
...
org $9C98A28; incbin ./graphics/gfx_youwon.bin
...
org $9C8F154; incbin ./graphics/gfx_healthtext_[c].bin
...
org $9B90140; incbin ./graphics/gfx_offdef_[c].bin
...
org $8DD6054; incbin ./graphics/gfx_sheriff1_[c].bin
org $8DD5D60; incbin ./graphics/gfx_sheriff2_[c].bin
org $9640AD0; incbin ./graphics/gfx_knock.bin
org $9692350; incbin ./graphics/gfx_ice.bin

// - General
org $8E5D270; incbin ./graphics/gfx_end0_[c].bin
org $8EEDE28; incbin ./graphics/gfx_end1_[c].bin
org $8EEE358; incbin ./graphics/gfx_end2_[c].bin
org $9AF4EA0; incbin ./graphics/gfx_currency.bin
...
org $9C5F340; incbin ./graphics/gfx_main_menu_[c].bin
...
org $8F0CE20; incbin ./graphics/gfx_arcade_top_[c].bin
org $8F0D144; incbin ./graphics/gfx_arcade_bottom_[c].bin
...
// - Highway
org $8E748D0; incbin ./graphics/gfx_charge0_[c].bin
org $8E2539C; incbin ./graphics/gfx_charge1_[c].bin
org $8EEC604; incbin ./graphics/gfx_charge2_[c].bin
org $8ED4C38; incbin ./graphics/gfx_cafe_top_[c].bin
org $8ED4930; incbin ./graphics/gfx_cafe_bottom_[c].bin

// - Sketches
org $9B1F45C; incbin ./graphics/gfx_sketch_osohe_1.bin
org $9B81B5C; incbin ./graphics/gfx_sketch_osohe_2.bin
org $9B5E8DC; incbin ./graphics/gfx_sketch_tower.bin
org $9B73A7C; incbin ./graphics/gfx_sketch_highway.bin
org $9B6595C; incbin ./graphics/gfx_sketch_lab.bin

// Insert graphic for the CAST sprite
org $9659AB0; incbin ./graphics/gfx_cast1.bin
org $9658CB0; incbin ./graphics/gfx_cast2.bin
...
org $934E4A4; incbin ./logic/logic_pointer_36C.bin
org $934E4B4; incbin ./logic/logic_code_36C.bin
org $919A784; dd $001B8338
org $919A788; dd $001B8354
org $919A78C; dd $00E383F0
org $919A790; dd $00E38400
org $9350F48; incbin ./logic/logic_36D.bin
org $9FD1000; incbin ./logic/logic_36E.bin
...
org $921DE88; incbin ./logic/logic_pointer_058.bin
org $921DEB4; incbin ./logic/logic_code_058.bin
org $9198EE4; dd $00E39948
org $9198EE8; dd $00E3995C
org $9FD2558; incbin ./logic/logic_059.bin
...
org $9306BC0; incbin ./logic/logic_pointer_1D9.bin
org $9306BFC; incbin ./logic/logic_code_1D9.bin
org $9199AEC; dd $00E373F0
org $9199AF0; dd $00E37420
org $9FD0000; incbin ./logic/logic_1DA.bin
...
org $9364430; incbin ./logic/logic_multi_debug.bin
...
org $91C6880; incbin ./logic/logic_00E.bin
...
org $9FD6000; incbin ./logic/logic_00F.bin //Move this logic that's smaller
...
org $9FD5800; incbin ./logic/logic_pointer_277.bin
org $9FD5814; incbin ./logic/logic_code_277.bin
...
org $9369CD0; incbin ./logic/logic_fix_debug_pigmask.bin
...
org $91EA604; incbin ./logic/logic_leder_memo.bin
...
org $91A778C; incbin ./logic/logic_leder_fix_song.bin
...
org $931C194; incbin ./logic/logic_leder_fix_counter_fireplace.bin
org $9FD5F00; incbin ./logic/logic_pointer_283.bin //Move ther pointers of the table next to that one in order to make room for the code
...
org $9285D70; incbin ./logic/logic_code_0E9.bin
org {logic_0EA_new_address}; incbin ./logic/logic_0EA.bin
...
org $9369CE8; incbin ./logic/logic_fix_debug_chapter7_kumatora.bin
